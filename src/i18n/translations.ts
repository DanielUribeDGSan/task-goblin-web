...
export const translations = {
  en: {
    ...
    chat: {
      ...
      licenseQuestion: "Where do I get my license?",
      licenseResponse: "You can obtain your license in the menu below, using the Lock icon.",
      consultQuestion: "How do I check my license?",
      consultResponse: "You can check your license in the menu below, using the Search icon (magnifying glass).",
      ...
      trialQuestion: "How long is the trial?",
      trialResponse: "All our apps have a 48-hour free trial for you to test without commitment.",
      nexoDetail: "Command center for developers: local domains, tunnels, environment variables, and more.",
      taskGoblinDetail: "Task automation: mouse movement, WhatsApp messages, PDF conversion, and more.",
      floatyDetail: "Native floating widgets to keep what you need always at hand.",
      contact: "Contact",
  ...
  es: {
    ...
    chat: {
      ...
      licenseQuestion: "¿Dónde obtengo mi licencia?",
      licenseResponse: "Puedes obtener tu licencia en el menú de abajo, usando el icono de candado.",
      consultQuestion: "¿Cómo consulto mi licencia?",
      consultResponse: "Puedes consultar tu licencia en el menú de abajo, usando el icono de Búsqueda (lupa).",
      ...
      trialQuestion: "¿Cuánto dura la prueba?",
      trialResponse: "Todas nuestras apps tienen una prueba gratuita de 48 horas para que las pruebes sin compromiso.",
      nexoDetail: "Centro de mando para desarrolladores: dominios locales, túneles, variables de entorno y más.",
      taskGoblinDetail: "Automatización de tareas: movimiento de mouse, mensajes de WhatsApp, conversión de PDF y más.",
      floatyDetail: "Widgets flotantes nativos para tener siempre a la mano lo que necesitas.",
      contact: "Contacto",
