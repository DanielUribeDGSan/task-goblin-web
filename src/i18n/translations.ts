...
export const translations = {
  en: {
    ...
    chat: {
      ...
      priceResponse: "TaskNotch: $149 MXN / $8 USD. Task Goblin: $149 MXN / $8 USD. Nexo: $149 MXN / $8 USD. Floaty: $50 MXN / $3 USD.",
      ...
      taskNotchDetail: "Interactive notch menu: AI Magic Eraser, OCR screenshot to text, screen translation, on-demand AI model downloads, local PDF editing tools, and quick settings.",
  ...
  es: {
    ...
    bottomBar: {
      ...
      buyLicense: "Comprar funciones Pro",
      mac: "Mac",
      windows: "Windows",
      appleSilicon: "Apple Silicon (M1/M2/M3/M4/M5) & Neo",
      intel: "Intel",
    ...
    chat: {
      ...
      taskNotchDetail: "Menú interactivo en el notch: borrador mágico con IA, Screenshot to Text OCR, traducción de pantalla con IA, descargas de modelos IA bajo demanda, herramientas de PDF y ajustes.",
